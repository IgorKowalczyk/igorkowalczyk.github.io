 ...
 links: [
  {
   ...
   title: "Email",
   icon: (
    <svg xmlns="http://www.w3.org/2000/svg" className="size-5 duration-200 motion-reduce:transition-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
   ...
   title: "Discord",
   icon: (
    <svg className="size-5 fill-[#5865F2] duration-200 motion-reduce:transition-none" width="71" height="55" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
   ...
   title: "Twitter / X",
   icon: (
    <svg className="size-5 fill-black duration-200 motion-reduce:transition-none dark:fill-white" fill="currentColor" height="16" viewBox="0 0 22 20">
  ...
  },
  {
   ...
   title: "Instagram",
   icon: (
    <svg fill="none" className="size-5" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
     <g clipPath="url(#g)">
