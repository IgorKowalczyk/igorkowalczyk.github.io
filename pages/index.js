 ...
 return (
  <Container title={`${config.title} - Portfolio`}>
   ...
   <div className="mx-auto -mt-24 flex min-h-screen flex-1 flex-col justify-center duration-300 motion-reduce:transition-none md:w-[90%] xl:w-4/5">
    <div className="md:grid-cols-0 grid lg:grid-cols-5 px-8">
   ...
   <div>
    <hr className="px-8 border-1 m-[0_auto] mb-8 border-gray-200 duration-300 motion-reduce:transition-none dark:border-gray-800" />
    <div className="px-8 m-[0_auto] mb-8 grid grid-cols-3 gap-y-10 gap-x-6 text-center font-poppins text-black/70 dark:text-white/70 md:grid-cols-4 md:gap-x-10 lg:grid-cols-4">
   ...
   <div className="mx-auto text-center" id={"about"}>
    ...
    <div className="relative">
     <div className="px-8 xl-grid-cols-4 mb-8 grid grid-cols-1 gap-y-10 gap-x-6 pb-4 text-center font-poppins text-black dark:text-white md:grid-cols-2 md:gap-x-10 lg:grid-cols-3">
      {repositories.most_popular_repos_data &&
       repositories.most_popular_repos_data.map((repo) => (
        <div key={repo.id} className="rounded-[10px] border-[1px] border-black/[15%] bg-gradient-to-r p-5 duration-200 hover:scale-105 hover:shadow-xl motion-reduce:transition-none motion-reduce:hover:scale-100 dark:border-white/[15%] dark:from-[#a2facf09] dark:to-[#64acff0d]">
         ...
         <div className="mt-2 flex gap-1 overflow-x-auto overflow-hidden">
          <NextLink key="repo_lang" href={`${repo.url}/search?l=${repo.primaryLanguage ? repo.primaryLanguage.name : "Markdown"}`}>
           <a target="_blank">
            <span className="w-max flex content-center items-center rounded-lg border-2 border-transparent bg-black/[5%] py-[0.12em] px-[0.5em] text-[88%] text-black/[60%] duration-200 motion-reduce:transition-none dark:bg-white/10 dark:text-white/[70%]">
          ...
          <NextLink key="repo_stars" href={`${repo.url}/stargazers`}>
           <a target="_blank">
            <span className="w-max flex content-center items-center rounded-lg border-2 border-transparent bg-black/[5%] py-[0.12em] px-[0.5em] align-middle text-[88%] text-black/[60%] duration-200 motion-reduce:transition-none dark:bg-white/10 dark:text-white/[70%]">
     ...
     <div className="pointer-events-visible absolute inset-x-0 bottom-0 flex pt-32 pb-8 duration-300  shadow-fadeSectionLight dark:shadow-fadeSectionDark">
      <NextLink href="/github" key="see_more_repos">
       <div className="flex flex-1 flex-col items-center justify-center duration-200 motion-reduce:transition-none">
        <a href="/github" key="see_more_repos" target="_self" className="arrow animatedLink group pointer-events-auto relative mt-5 inline-block items-center justify-center p-2 pl-0 pr-0 pb-1 font-semibold duration-200 motion-reduce:transition-none">
