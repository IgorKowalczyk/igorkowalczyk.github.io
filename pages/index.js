 ...
 return (
  <Container title={`${config.title} - Portfolio`}>
   ...
   <div>
    ...
    <div className="m-[0_auto] mb-8 grid grid-cols-3 gap-y-10 gap-x-6 text-center font-poppins text-black/70 dark:text-white/70 md:grid-cols-4 md:gap-x-10 lg:grid-cols-4">
   ...
   <div className="mx-auto text-center" id={"about"}>
    ...
    <div className="relative">
        ...
        <div key={repo.id} className="rounded-[10px] border-[1px] border-black/[15%] bg-gradient-to-r p-5 duration-200 hover:scale-105 hover:shadow-xl motion-reduce:transition-none motion-reduce:hover:scale-100 dark:border-white/[15%] dark:from-[#a2facf09] dark:to-[#64acff0d]">
         ...
         <div className="mt-2 flex gap-1">
          ...
          <NextLink key="repo_stars" href={`${repo.url}/stargazers`}>
           <a target="_blank">
            <span className="flex content-center items-center rounded-lg border-2 border-transparent bg-black/[5%] py-[0.12em] px-[0.5em] align-middle text-[88%] text-black/[60%] duration-200 motion-reduce:transition-none dark:bg-white/10 dark:text-white/[70%]">
     ...
     <div class="pointer-events-visible absolute inset-x-0 bottom-0 flex bg-gradient-to-t from-white pt-32 pb-8 duration-200 transition-colors motion-reduce:transition-none dark:from-[#040d21]">
      <NextLink href="/github">
       <div class="flex flex-1 flex-col items-center justify-center duration-200 motion-reduce:transition-none">
        <a className="duration-200 motion-reduce:transition-none arrow animatedLink group pointer-events-auto relative mt-5 inline-block items-center justify-center p-2 pl-0 pr-0 pb-1 font-semibold" href="/github">
         See more repos
         <svg xmlns="http://www.w3.org/2000/svg" className="arrowSymbol inline-block translate-x-[5px] duration-200 group-hover:translate-x-[10px] motion-reduce:transition-none" width="16" height="16" viewBox="0 0 16 16" fill="none">
          <path fill="currentColor" d="M7.28033 3.21967C6.98744 2.92678 6.51256 2.92678 6.21967 3.21967C5.92678 3.51256 5.92678 3.98744 6.21967 4.28033L7.28033 3.21967ZM11 8L11.5303 8.53033C11.8232 8.23744 11.8232 7.76256 11.5303 7.46967L11 8ZM6.21967 11.7197C5.92678 12.0126 5.92678 12.4874 6.21967 12.7803C6.51256 13.0732 6.98744 13.0732 7.28033 12.7803L6.21967 11.7197ZM6.21967 4.28033L10.4697 8.53033L11.5303 7.46967L7.28033 3.21967L6.21967 4.28033ZM10.4697 7.46967L6.21967 11.7197L7.28033 12.7803L11.5303 8.53033L10.4697 7.46967Z"></path>
          <path stroke="currentColor" d="M1.75 8H11" strokeWidth={2} strokeLinecap="round"></path>
