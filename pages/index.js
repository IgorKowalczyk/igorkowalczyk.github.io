  ...
  <Container title={`${config.title} - Portfolio`}>
   ...
   <div className="mx-auto -mt-24 flex min-h-screen flex-1 flex-col justify-center duration-300 motion-reduce:transition-none md:w-[90%] xl:w-4/5">
    <div className="md:grid-cols-0 grid px-8 lg:grid-cols-5">
     ...
     <div className="hidden items-center motion-reduce:transition-none md:col-span-3 md:mt-7 md:-mb-7 lg:mt-0 lg:mb-0 md:flex lg:col-span-2">
   ...
   <div className="mx-auto text-center scroll-mt-20" id={"about"}>
      ...
      {repositories.most_popular_repos_data &&
       repositories.most_popular_repos_data.map((repo) => (
        <div key={repo.id} className="rounded-[10px] border-[1px] border-black/[15%] bg-gradient-to-r p-5 duration-200 hover:scale-105 hover:shadow-xl motion-reduce:transition-none motion-reduce:hover:scale-100 dark:border-white/[15%] dark:from-[#a2facf09] dark:to-[#64acff0d]">
         ...
         <div className="mt-2 flex gap-1 overflow-hidden overflow-x-auto hide-scrollbar snap-x snap-mandatory">
          <NextLink key="repo_lang" href={`${repo.url}/search?l=${repo.primaryLanguage ? repo.primaryLanguage.name : "Markdown"}`}>
           <a target="_blank">
            <span className="snap-always snap-center flex w-max content-center items-center rounded-lg border-2 border-transparent bg-black/[5%] py-[0.12em] px-[0.5em] text-[88%] text-black/[60%] duration-200 motion-reduce:transition-none dark:bg-white/10 dark:text-white/[70%]">
          ...
          <NextLink key="repo_stars" href={`${repo.url}/stargazers`}>
           <a target="_blank">
            <span className="snap-always snap-center flex w-max content-center items-center rounded-lg border-2 border-transparent bg-black/[5%] py-[0.12em] px-[0.5em] align-middle text-[88%] text-black/[60%] duration-200 motion-reduce:transition-none dark:bg-white/10 dark:text-white/[70%]">
