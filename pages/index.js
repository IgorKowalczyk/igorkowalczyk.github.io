   ...
   <div className="mx-auto -mt-24 flex min-h-screen flex-1 flex-col justify-center md:w-[90%] xl:w-4/5 duration-300">
    <div className="md:grid-cols-0 grid lg:grid-cols-5">
     <div className="md:col-span-3">
      ...
      <div className="mt-4 md:block flex justify-center">
       <Link href="/about">
        <a className="group mt-5 items-center justify-center p-2 pl-0 pr-0 pb-1 font-semibold arrow relative inline-block animatedLink">
         More about me
