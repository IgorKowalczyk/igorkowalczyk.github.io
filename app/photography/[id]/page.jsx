...
export default async function PhotoPage({ params: { id } }) {
 ...
 return (
  <div className="mx-auto mb-16 flex flex-col items-start justify-center">
   ...
   <Image className="scale-100 transform rounded-lg bg-gray-200 blur-0 duration-200 will-change-auto dark:bg-neutral-200/[15%]" src={photo.path} alt={photo.path} width={720} height={480} sizes="(max-width: 640px) 100vw, (max-width: 1280px) 50vw, (max-width: 1536px) 33vw, 25vw" />
  </div>
 );
}
