...
<a href="https://tailwindcss.com/" className="mb-6 inline-block cursor-pointer rounded bg-blue-500 py-2 px-4 font-semibold !text-white duration-200 hover:bg-blue-600">
 <span>Tailwind</span>
</a>

```js {1} title="page.jsx" showLineNumbers
<a href="https://tailwindcss.com/" className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded duration-200 inline-block cursor-pointer">
<span>Tailwind</span>
</a>
```
