...
function NavItem({ href, text, target }) {
 ...
 return (
  <NextLink href={href} key={href}>
   <a target={target} key={href} className={`${isActive ? "pseudo-border-active font-semibold text-gray-800 dark:text-gray-200" : "font-normal text-gray-600 dark:text-gray-400"} pseudo-border before:w-[calc(100%_-_1.5em)] after:w-[calc(100%_-_1.5em)] relative hidden rounded-lg p-1 transition-all duration-200 hover:bg-gray-200 motion-reduce:transition-none dark:hover:bg-white/10 hover:text-gray-800 dark:hover:text-gray-200 sm:px-3 sm:py-2 md:inline-block`}>
  ...
  <div className="fixed top-0 z-[100] mx-0 mt-0 w-full font-poppins shadow dark:shadow-2xl">
   <nav key="nav" className="relative mx-auto flex h-[73px] w-full items-center justify-between border-b-[1px] border-white/[15%] bg-white bg-opacity-70 pt-4 pb-4 duration-300 firefox:bg-opacity-100 motion-reduce:transition-none dark:bg-[#08152b] dark:bg-opacity-70 dark:firefox:bg-opacity-100">
    ...
    <div className="mr-auto flex gap-1">
     ...
     {({ open }) => (
      <>
       <Popover.Button className={`${open ? "bg-gray-200 text-gray-800 dark:bg-white/10 dark:text-gray-200 pseudo-border-active" : ""} pseudo-border relative group hidden rounded-lg p-1 font-poppins text-gray-600 outline-none transition-all duration-200 hover:bg-gray-200 hover:text-gray-800 motion-reduce:transition-none dark:text-gray-400 dark:hover:bg-white/10 sm:px-3 sm:py-2 md:flex md:items-center`}>
        <span>More</span>
        <svg xmlns="http://www.w3.org/2000/svg" className={`${open ? "-rotate-90 text-gray-800 dark:text-gray-200" : ""} ml-1 h-4 w-4 text-gray-600 duration-150 ease-in-out group-hover:-rotate-90 group-hover:text-gray-800`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <Popover.Panel unmount={false} className="absolute left-1/2 z-10 w-screen max-w-sm -translate-x-1/2 transform px-4 pt-3 sm:px-0 ">
         <div className="overflow-hidden rounded-lg border-[1px] border-black/[10%] shadow-lg  dark:border-white/[15%]">
          <div className="relative bg-white p-7 dark:bg-[#08152b]">
           ...
           <NextLink href="/blog" key="github">
            <a onClick={() => setIsPopoverShowing(false)} key="github_navbar" className="-m-3 mt-4 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-blue-50/80 dark:hover:bg-white/5">
             <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-blue-100 text-white dark:bg-white/10 dark:text-black sm:h-12 sm:w-12">
              <svg xmlns="http://www.w3.org/2000/svg" className="inline h-[24px] w-[24px] stroke-black duration-200 motion-reduce:transition-none dark:stroke-white/[70%]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
           ...
           <NextLink href="/contact" key="contact_navbar">
            <a onClick={() => setIsPopoverShowing(false)} key="solutions" className="-m-3 mt-4 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-blue-50/80 dark:hover:bg-white/5">
             <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-blue-100 text-white dark:bg-white/10 dark:text-black sm:h-12 sm:w-12">
              <svg xmlns="http://www.w3.org/2000/svg" className="inline h-[24px] w-[24px] stroke-black duration-200 motion-reduce:transition-none dark:stroke-white/[70%]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
