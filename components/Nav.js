  ...
  <div className="fixed top-0 z-[100] mx-0 mt-0 w-full font-poppins shadow dark:shadow-2xl">
   <nav key="nav" className="relative mx-auto flex h-[73px] w-full items-center justify-between border-b-[1px] border-white/[15%] bg-white bg-opacity-70 pt-4 pb-4 duration-300 firefox:bg-opacity-100 motion-reduce:transition-none dark:bg-[#08152b] dark:bg-opacity-70 dark:firefox:bg-opacity-100">
    ...
    <div className="text-right">
     <button type="button" onClick={() => setIsOpen(true)} className="group ml-4 mr-[1.4rem] flex h-9 w-9 items-center justify-center rounded-lg border-2 border-transparent bg-transparent transition-all duration-300 hover:border-[#3391fc] motion-reduce:transition-none dark:bg-white/10 dark:hover:border-[#5686f5]">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-800 duration-200 group-hover:rotate-90 group-hover:transform motion-reduce:transition-none dark:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
     ...
     <div className="fixed inset-0 overflow-y-auto">
      <div className="flex min-h-full items-center justify-center p-4 text-center font-poppins">
       <Transition.Child as={Fragment} enter="ease-out duration-200 motion-reduce:transition-none" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="ease-in duration-200 motion-reduce:transition-none" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
        <Dialog.Panel className="hide-scrollbar w-full max-w-md transform overflow-x-scroll rounded-2xl border-[1px] border-black/[15%] bg-white p-6 text-left align-middle shadow-xl transition-all dark:border-white/[15%] dark:bg-[#121e32]">
         ...
         <div className="mt-2 divide-y divide-black/20 dark:divide-white/20">
          ...
          <button className="group flex w-full cursor-auto select-text items-center py-3 text-sm text-black duration-200 motion-reduce:transition-none dark:text-white">
           Animations
           <div className="ml-auto w-32">
            <Listbox value={animate} onChange={(t) => null}>
             {({ open }) => (
              <div className="relative">
               ...
               <Transition show={open} as={Fragment} enter="transition ease-out duration-200 motion-reduce:transition-none" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-100 motion-reduce:transition-none" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
                <Listbox.Options className="absolute z-[100] mt-1 max-h-60 w-full scale-100 transform overflow-auto rounded-md border-[1px] border-black/[10%] bg-white bg-opacity-70 py-1 text-base opacity-100 shadow-2xl backdrop-blur-[9px] firefox:bg-opacity-100 dark:border-white/[15%] dark:bg-[#08152b] dark:bg-opacity-[85%] dark:firefox:bg-opacity-100 sm:text-sm">
         ...
         <a target="_blank" rel="noreferrer" href={`https://github.com/${config.social.github.username}/${config.social.github.repo}`} className="group full flex items-center rounded-md px-2 py-3 text-sm text-black duration-200 motion-reduce:transition-none dark:text-white">
              Source code{" "}
              <svg xmlns="http://www.w3.org/2000/svg" className="group-hover:opacity-90 duration-100 motion-reduce:transition-none ml-2 h-4 w-4 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
