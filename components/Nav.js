 ...
 return (
  <div className="fixed top-0 z-[100] mx-0 mt-0 w-full font-poppins shadow-2xl backdrop-blur-[8px]">
   <nav className="relative mx-auto flex w-full items-center justify-between border-b-[1px] border-white/[15%] bg-white pt-4 pb-4 dark:bg-[#08152b] dark:bg-opacity-70">
    ...
    <button aria-label="Toggle Dark Mode" type="button" className="mx-8 flex h-9 w-9 items-center justify-center rounded-lg bg-gray-200 transition-all dark:bg-white/10 border-2 border-transparent hover:shadow-hover hover:border-[#5686f5] duration-300" onClick={() => setTheme(resolvedTheme === "dark" ? "light" : "dark")}>
     {mounted && (
