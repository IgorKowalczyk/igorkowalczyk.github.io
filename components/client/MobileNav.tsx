...
export default function MobileNav() {
 ...
 return (
  <Drawer.Root noBodyStyles={true} direction="left" open={isMenuOpen} onOpenChange={() => setIsMenuOpen(!isMenuOpen)}>
   <Drawer.Trigger className={cn(buttonSecondaryStyles, "size-10 justify-center border-0 !bg-transparent !outline-none hover:!bg-gray-300 dark:hover:!bg-white/15 lg:hidden")}>
   ...
   <Drawer.Portal>
    ...
    <Drawer.Content className="fixed inset-y-0 left-0 z-10 flex w-full max-w-96 !outline-none">
     ...
     <div className="flex w-full max-w-96 flex-col border-r border-black/10 bg-white/90 p-6 backdrop-blur-xl duration-200 motion-reduce:transition-none dark:border-neutral-800 dark:bg-[#161617]/70">
