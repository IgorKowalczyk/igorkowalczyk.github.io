  ...
  <Link href={`/blog/${slug}`}>
   <a className="w-full">
    <li className="mb-10 ml-6 -mt-3 rounded-2xl px-6 py-3 duration-200 hover:bg-zinc-200/50 motion-reduce:transition-none dark:hover:bg-white/10">
     ...
     <time className="mb-2 block text-sm font-normal leading-none text-slate-500 dark:text-slate-500" dateTime={parseISO(publishedAt)}>{format(parseISO(publishedAt), "MMMM dd, yyyy")}</time>
