...
export default function MobileNav() {
 ...
 return (
  <>
   ...
   <div className={`${isMenuOpen ? "rendered !opacity-100 pointer-events-all" : "pointer-events-none"} absolute left-0 top-0 z-[1001] mt-[73px] flex h-screen w-3/4 flex-col opacity-0 backdrop-blur-xl duration-200 motion-reduce:transition-none md:hidden`}>
