...
export function CodeCard({ userData, contributions }) {
 return (
  <div className="card border-b-black/15 shadow-code block w-full rounded-md border font-mono text-[15px] text-sm backdrop-blur-md transition-colors motion-reduce:transition-none dark:border-[1px] dark:border-neutral-800 dark:bg-[#161617]/30">
