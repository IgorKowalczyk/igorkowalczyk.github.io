...
export const contact = {
 links: [
  ...
  },
  {
   ...
   title: "Discord",
   icon: (
    <svg className="h-5 w-5 fill-blue-900 duration-200 motion-reduce:transition-none dark:fill-white" width="71" height="55" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
   ...
   title: "Twitter",
   icon: (
    <svg className="h-5 w-5 fill-blue-900 duration-200 motion-reduce:transition-none dark:fill-white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 248 204">
     <path
  ...
  },
  {
   ...
   title: "Instagram",
   icon: (
    <svg className="h-5 w-5 fill-blue-900 duration-200 motion-reduce:transition-none dark:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
