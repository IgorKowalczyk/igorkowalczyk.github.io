 ...
 links: [
  {
   ...
   title: "Email",
   icon: (
    <svg xmlns="http://www.w3.org/2000/svg" className="mr-2 mt-[2px] h-4 w-4 duration-200 motion-reduce:transition-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
   ...
   title: "Discord",
   icon: (
    <svg className="mr-2 mt-[2px] h-4 w-4 fill-blue-900 duration-200 motion-reduce:transition-none dark:fill-white" width="71" height="55" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
   ...
   title: "Twitter",
   icon: (
    <svg className="mr-2 mt-[2px] h-4 w-4 fill-blue-900 duration-200 motion-reduce:transition-none dark:fill-white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 248 204">
     <path
  ...
  },
  {
   ...
   title: "Instagram",
   icon: (
    <svg className="mr-2 mt-[2px] h-4 w-4 fill-blue-900 duration-200 motion-reduce:transition-none dark:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
